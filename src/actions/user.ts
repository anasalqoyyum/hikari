...
export const createUserWithAccessCode = async (code: string) => {
  ...
  if (existingUser)
    return {
      error: true,
      message: 'That access code is already in use',
      data: [],
    }
