...
export const HikariStatus = ({
  ...
  return (
    <Card className={`${className} px-2 py-1`}>
      ...
      <CardBody className="pt-2 flex flex-col flex-wrap gap-0.5 md:text-lg overflow-hidden">
        ...
        {!!status.teamCount && (
          <span>
            <span className="font-semibold">Team Count: </span>
            {status.teamCount}
          </span>
        )}
        {!!status.arcadeCount && (
          <span>
            <span className="font-semibold">Arcade Count: </span>
            {status.arcadeCount}
          </span>
        )}
        {status.chuniVersion !== null && (
          <span>
            <span className="font-semibold">Latest Chunithm Version: </span>
            {CHUNI_VERSIONS[status.chuniVersion]}
          </span>
        )}
      </CardBody>
    </Card>
